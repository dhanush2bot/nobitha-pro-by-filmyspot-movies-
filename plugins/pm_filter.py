        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧', url ='https://t.me/+o_VcAI8GRQ8zYzA9')
                        ]]
                    )
                )
...
async def cb_handler(client: Client, query: CallbackQuery):
            ...
            if (AUTH_CHANNEL or REQ_CHANNEL) and not await is_subscribed(client, query):
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton("🔰  ᴊᴏɪɴ ꜰᴏʀ ᴍᴏᴠɪᴇs​  🔰", url="https://t.me/+o_VcAI8GRQ8zYzA9")
                         ]
                        ]
                    )
                )
    ...
    #    ],[
            InlineKeyboardButton('🔸 ɢʀᴏᴜᴘ ', url="https://t.me/+o_VcAI8GRQ8zYzA9"),
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ 🔸', url="https://t.me/filmyspotmovie")
        ],[
            InlineKeyboardButton('🔸 ꜱᴜᴘᴘᴏʀᴛ ', url="https://t.me/+i-k-rBOg9CE3NGU1"),
            InlineKeyboardButton(' ᴜᴘᴅᴀᴛᴇꜱ 🔸', url="https://t.me/filmyspotupdate")
        ],[
  ...
  #          InlineKeyboardButton('🔸 ꜱᴜʙꜱᴄʀɪʙᴇ  ᴍʏ  ʏᴛ  ᴄʜᴀɴɴᴇʟ 🔸', url='https://youtube.com/@NobiDeveloper')
            ...
            InlineKeyboardButton('🔸 ʀᴇᴘᴏʀᴛ  ʙᴜɢꜱ  ᴀɴᴅ  ꜰᴇᴇᴅʙᴀᴄᴋ 🔸', url='https://t.me/FilmySpotSupport_bot')
        ],[
            InlineKeyboardButton('🔸 ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('ᴍᴏᴠɪᴇꜱ 🔸', url='https://t.me/+o_VcAI8GRQ8zYzA9')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("🪙   ᴘʟᴇᴀsᴇ  ᴅᴏɴᴀᴛᴇ   🪙", url="https://t.me/FilmySpotSupport_bot")
                 ],[
                    InlineKeyboardButton("ʙᴀᴄᴋ", callback_data="start"),
