...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔸 ᴜᴘᴅᴀᴛᴇꜱ 🔸', url="https://t.me/FilmySpotSupport_bot")
            ],
            [
                InlineKeyboardButton('🔸 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ 🔸', url=f"https://t.me/filmyspotmovie"),
            ]
            ]
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton("🔳 ᴄʜᴀɴɴᴇʟ​ 🔳", url="https://t.me/filmyspotmovie")
                         ]
                        ]
                    )
                )
        ...
        for file in files:
            ...
            if not files_:
                ...
                try:
                    if not await check_verification(client, message.from_user.id) and IS_VERIFY == True:
                        btn = [[
                            InlineKeyboardButton("✅  ᴄʟɪᴄᴋ ᴛᴏ ᴠᴇʀɪꜰʏ  ✅", url=await get_token(client, message.from_user.id, f"https://telegram.me/{temp.U_NAME}?start=", file_id))
                        ],[
                            InlineKeyboardButton('❓  ʜᴏᴡ ᴛᴏ ᴠʀɪꜰʏ  ❓', url="https://t.me/filmyspotupdate/76")
                        ]]
            ...
            if not await check_verification(client, message.from_user.id) and IS_VERIFY == True:
                btn = [[
                            ...
                            InlineKeyboardButton('❓  ʜᴏᴡ ᴛᴏ ᴠᴇʀɪꜰʏ  ❓', url="https://t.me/filmyspotupdate/76")
                    ]]
                await message.reply_text(
                    text="<b>You are not verified !\nKindly verify to continue !</b>",
                    protect_content=True,
 ...
 #           ],[
 #               InlineKeyboardButton('🎪  ꜱᴜʙꜱᴄʀɪʙᴇ ᴍʏ ʏᴛ ᴄʜᴀɴɴᴇʟ  🎪', url='http://www.youtube.com/@FilmySpot0')
            ]]
            await message.reply_photo(
        ...
        try:
            if IS_VERIFY and not await check_verification(client, message.from_user.id):
                btn = [[
                    ...
                    InlineKeyboardButton('❓  ʜᴏᴡ ᴛᴏ ᴠᴇʀɪꜰʏ  ❓', url="https://youtu.be/GdaUbzxDTKs")
                ]]
                await message.reply_text(
    ...
    if IS_VERIFY and not await check_verification(client, message.from_user.id):
        ...
        await message.reply_text(
            text=f"<b> {message.from_user.mention},</b>\n\nʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰɪᴇᴅ ᴛᴏᴅᴀʏ,\nᴘʟᴇᴀꜱᴇ ᴠᴇʀɪꜰʏ ɴᴏᴡ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ 😊\n\n<b>इस  बॉट  को  इस्तेमाल  करने  के  लिए  आपको  ᴠᴇʀɪꜰʏ  करना  होगा  नहीं  तो  आप  इसका  इस्तेमाल  नहीं  कर  पाएंगे ।😊\n\n<b>ಈ ಬೋಟ್ ಅನ್ನು ಬಳಸಲು ನೀವು ᴠᴇʀɪꜰʏ ಮಾಡಬೇಕು ಇಲ್ಲದಿದ್ದರೆ ನೀವು ಅದನ್ನು ಬಳಸಲು ಸಾಧ್ಯವಾಗುವುದಿಲ್ಲ😊</b>",
            protect_content=True,
            reply_markup=InlineKeyboardMarkup(btn)
        )
        return
...
async def shortlink(bot, message):
    btn = [[
#       InlineKeyboardButton(text="ʀᴇᴘᴏ", url="https://github.com/"),
#        InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="https://t.me/FilmySpotSupport_bot")
#        ],[
        InlineKeyboardButton(text="ᴀᴅᴅ  ʏᴏᴜʀ  ꜱʜᴏʀᴛɴᴇʀ", url="http://telegram.me/{temp.U_NAME}?startgroup=true")
    ],[
        InlineKeyboardButton(text="ɢᴏ ᴛᴏ ɪɴꜱᴛᴀɴᴛᴇᴀʀɴ", url="https://instantearn.in/ref/dhanushrs")
    ]]
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_photo(photo='https://telegra.ph/file/82130ac1a442350946dd9.jpg', caption="<b>──────「 <a href='https://t.me/FilmySpotSupport_bot'>ᴇᴀʀɴ ᴍᴏɴᴇʏ</a> 」──────\n\n➥ ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴇᴀʀɴ ʟᴏᴛs ᴏꜰ ᴍᴏɴᴇʏ ꜰʀᴏᴍ ᴛʜɪꜱ ʙᴏᴛ.\n\n›› sᴛᴇᴘ 𝟷 : ʏᴏᴜ ᴍᴜsᴛ ʜᴀᴠᴇ ᴀᴛʟᴇᴀsᴛ ᴏɴᴇ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴍɪɴɪᴍᴜᴍ 50 ᴍᴇᴍʙᴇʀs.\n\n›› ›› sᴛᴇᴘ 𝟸 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ <a href='https://instantearn.in/ref/dhanushrs'>ɪɴꜱᴛᴀɴᴛᴇᴀʀɴ</a> ᴏʀ <a href='https://moneykamalo.com/ref/dhanushrs'>ᴍᴏɴᴇʏᴋᴀᴍᴀʟᴏ</a>. [ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴏᴛʜᴇʀ sʜᴏʀᴛɴᴇʀ ᴡᴇʙsɪᴛᴇ ]\n\n›› sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href='https://t.me/filmyspotupdate/72'>ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ</a>.</b>", reply_markup=InlineKeyboardMarkup(btn))
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
...
#        InlineKeyboardButton(text="ʀᴇᴘᴏ", url="https://github.com/NobiDeveloper/Nobita-Filter-Bot"),
 ...
 #       ],[
        InlineKeyboardButton(text="ᴀᴅᴅ  ʏᴏᴜʀ  ᴛᴜᴛᴏʀɪᴀʟ", url="http://telegram.me/{temp.U_NAME}?startgroup=true")
    ]]
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
